...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2024 at 06:37 AM
...
(1, 'Dial A for Aunties', 'Comedy', 'A murder mystery that is unexpectedly hilarious as the protagonist and her aunts attempt to dispose of a body.', 'image/bid1.jpg', NULL),
...
(3, 'The Candid Life of Meena Dave', 'Fiction', 'A feel-good book that follows a photojournalist unraveling a mystery in her new home.', 'image/bid3.jpg', NULL),
...
(6, 'The Hitchhiker\'s Guide to the Galaxy', 'Science Fiction', 'A comedic adventure that follows Arthur Dent as he navigates through space after the Earth is destroyed. Packed with British humor and absurd scenarios.', 'image/bid6.jpeg', NULL),
(7, 'The Thursday Murder Club', 'Mystery', 'A lighthearted murder mystery tackled by four witty septuagenarians.', 'image/bid7.jpeg', NULL),
(8, 'If the Shoe Fits', 'Romantic Comedy', 'A contemporary Cinderella story that’s both funny and romantic.', 'image/bid2.jpeg', NULL),
(9, 'Anxious People', 'Drama', 'A comedic novel set during a hostage situation, exploring human connections with wit.', 'image/bid9.jpg', NULL),
